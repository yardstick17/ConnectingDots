...
from neural_networks.tensorflow.dataset import image_classifier_dataset as dataset
...
# Prepare input data
# classes = ['ambiance', 'food', 'human', 'menu']
classes = ['low', 'high']
...
img_size = 128
num_channels = 3
train_path = '/home/kushwaha/training_data/eyeq/zomato_datasets'
